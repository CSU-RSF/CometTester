...
namespace CometTester.CFarm
{
    class AgroforestryValues
    {
        ...
        public void SetExpected(CFarmXmlLister.AgroforestryReport report)
        {
            Expected.Add(report.LiveTrees);
            Expected.Add(report.DownedDeadWood);
            Expected.Add(report.ForestFloor);
            Expected.Add(report.StandingDeadTrees);
